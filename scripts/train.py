...
from utils import get_device, tokenize_data, NewsDataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, required=True, help='Path to the CSV file containing fake news data')
